...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 28, 2019 at 02:20 PM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `usp_SetEvent` (IN `eventId` MEDIUMINT(9), IN `userId` SMALLINT(6), IN `clientId` SMALLINT(6), IN `eventName` VARCHAR(250), IN `eventCategoryId` TINYINT(4), IN `startDateTime` DATETIME, IN `endDateTime` DATETIME, IN `venue` VARCHAR(250), IN `guests` VARCHAR(500), IN `speakers` VARCHAR(500), IN `participants` VARCHAR(500), IN `eventDescription` TEXT, IN `eventStatusId` TINYINT(1), IN `serviceIdsOpted` TEXT, IN `isSubmitedForDM` BIT(1), IN `eventStatusDescription` TEXT, IN `newStartDateTime` DATETIME, IN `newEndDateTime` DATETIME, IN `isPhotoUploaded` BIT(1), IN `photoUploadedPath` TEXT, IN `isVideoUploaded` BIT(1), IN `videoUploadedPath` TEXT)  BEGIN

	SET eventId = IFNULL(eventId, 0);
	...
	ELSE
		...
		UPDATE tblEvents E SET
			...
			, E.EventCategoryId = eventCategoryId
			...
			, E.EventStatusId = eventStatusId
			, E.EventStatusDescription = eventStatusDescription
			, E.IsSubmitedForDM = isSubmitedForDM
			, E.LastModifiedOn = SysDate()
			, E.LastModifiedBy = userId
			, E.IsPhotoUploaded = isPhotoUploaded
			, E.IsVideoUploaded = isVideoUploaded
			, E.PostponedStartDateTime = newStartDateTime
			, E.PostponedEndDateTime = newEndDateTime
		WHERE
			E.EventId = @eventId;
		...
		IF eventStatusId = @StatusId_Postponed THEN
			INSERT INTO tblEvents
			(
				ClientId
				, EventCreatedBy
		...
		ELSE IF eventStatusId = @StatusId_Completed THEN
			IF isPhotoUploaded = 1 THEN
...
(30, 1, 7, 'jyothi birthday ', 2, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'hyderabad', 'anji,naga,jyothi,gafoor', 'anji,naga,jyothi,gafoor', 'a,b,c', 'test c', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, b'1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2019-08-27 23:50:17', 7),
...
(1, 'mdgafoor1@gmail.com', 0xaed3addc330b975ed5b7705dff22466cb583ca7f, 0x4e9d7e57403d2ec0bd84c29a637af573d2d99b34, 2, NULL, NULL, NULL, NULL, NULL, NULL, '2019-08-27 15:41:29', b'1'),
...
(6, 'srinivas846@gmail.com', 0xaed3addc330b975ed5b7705dff22466cb583ca7f, 0x4e9d7e57403d2ec0bd84c29a637af573d2d99b34, 7, NULL, NULL, NULL, NULL, NULL, NULL, '2019-08-28 14:11:05', b'1'),
...
(18, 'sai@gmail.com', 0x769c0c1f4f4378c2740efb4cfe6133a401c3661a, 0xfaaad0a8e5f93139a96a5d0dff7e97fbf5737804, 19, NULL, NULL, NULL, NULL, NULL, NULL, NULL, b'1'),
...
--
ALTER TABLE `tblevents`
  MODIFY `EventId` mediumint(9) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT for table `tbleventservicedata`
--
ALTER TABLE `tbleventservicedata`
  MODIFY `EventServiceDataId` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbleventservices`
--
ALTER TABLE `tbleventservices`
  MODIFY `EventServiceId` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2134;
...
--
ALTER TABLE `tblreleaseeventlock`
  MODIFY `ReleaseEventLockId` mediumint(9) UNSIGNED NOT NULL AUTO_INCREMENT;
COMMIT;
